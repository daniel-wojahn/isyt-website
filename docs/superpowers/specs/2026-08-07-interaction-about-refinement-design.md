...
- Use black bars over gold listing pages and white pages; retain white bars only over the darkened homepage hero.
...
- Keep the established gold `#ce933a`, black, white, and gray palette, with an accessible dark brown `#76501c` for links on white.
- On white sections, use dark brown links with black hover states.
- On gold sections, use black text and controls; selected tabs use white on black so no link, subheading, FAQ label, or selected tab disappears into the background.
...
- Retain the live page's 30/70 history rows and generous gold-section spacing, using accessible black typography and dark separators.
- Style FAQ summaries as visible black rows with a small disclosure marker and clear hover/focus feedback.
